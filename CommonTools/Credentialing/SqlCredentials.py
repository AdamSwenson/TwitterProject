"""
Object which holds the credentials for mysql database access
"""
__author__ = 'adam'
...
class Credential(object):
    ...
    def load_credentials(self, credentials_file):
        ...
        self.db_host = credentials.find('db_host')
        self.db_port = credentials.find('db_port')
        if self.db_port is not None:
            self.db_port = int(self.db_port)
        self.db_user = credentials.find('db_user')
        self.db_name = credentials.find('db_name')
        self.db_password = credentials.find('db_password')
...
class TestingCredentialLoader( CredentialLoader ):
    """
