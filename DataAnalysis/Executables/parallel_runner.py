...
if __name__ == '__main__':
    ...
    sys.path.append( "%s/DataAnalysis" % ROOT )

    # /Users/adam/Dropbox/TwitterProject/DataAnalysis/
    from DatabaseServer import Servers as Commander
    from Server import ServerTools as DSG
...
# print(j)
# a = e1.apply( ServerTools.DatabaseServerGrumble.main)
# print(a.get())
# # a.get()
...
#     from ServerTools import DatabaseServerGrumble as DSG
